...
_SCHEME_VARIANTS=('' '-Darker' '-Oceanic' '-Palenight')
...
cd .. && ./install.sh -d $THEME_DIR -t all && ./install.sh -d $THEME_DIR --tweaks darker -t all && ./install.sh -d $THEME_DIR --tweaks oceanic -t all && ./install.sh -d $THEME_DIR --tweaks palenight -t all
