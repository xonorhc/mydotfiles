...
M.base_16 = {
	...
	base08 = "{{ colors.purple_source.default.hex | lighten: 0.10 }}",
	base09 = "{{ colors.orange_source.default.hex | lighten: 0.15 }}",
	base0A = "{{ colors.cyan_source.default.hex | lighten: 0.30 }}",
	base0B = "{{ colors.yellow_source.default.hex | lighten: 0.10 }}",
	base0C = "{{ colors.cyan_source.default.hex | lighten: 0.10 }}",
	base0D = "{{ colors.green_source.default.hex | lighten: 0.20 }}",
	base0E = "{{ colors.pink_source.default.hex | lighten: 0.20 }}",
	base0F = "{{ colors.red_source.default.hex | lighten: 0.20 }}",
}
...
M = require("base46").override_theme(M, "chadwal")
