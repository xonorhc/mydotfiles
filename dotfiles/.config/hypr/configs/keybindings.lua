...
hl.bind(mainMod .. " + W",         hl.dsp.exec_cmd(Run .. Browser))
hl.bind(mainMod .. " + SHIFT + W", hl.dsp.exec_cmd(Run .. Browser .. "--private-window"))
...
hl.bind(mainMod .. " + A",         hl.dsp.exec_cmd("pkill " .. Menu .. " || " .. Run .. Menu .. "-show drun -modi drun,filebrowser,run,window"))
hl.bind("SHIFT + Tab",             hl.dsp.exec_cmd(Run .. Menu .. "-show window -replace -config " .. menuConfig .. "config-compact.rasi"))
hl.bind(mainMod .. " + V",         hl.dsp.exec_cmd("cliphist list | " .. Run .. Menu .. "-dmenu -display-columns 2 -replace -config " .. menuConfig .. "config-cliphist.rasi | cliphist decode | wl-copy"))
hl.bind(mainMod .. " + ALT + W",   hl.dsp.exec_cmd(ScriptsDir .. "rofi-websearch"))
...
hl.bind(mainMod .. " + C",         hl.dsp.exec_cmd(screenshot .. "-m active -m window"))
hl.bind(mainMod .. " + ALT + C",   hl.dsp.exec_cmd(screenshot .. "-m active -m output"))
hl.bind(mainMod .. " + SHIFT + C", hl.dsp.exec_cmd(screenshot .. "-m region"))
