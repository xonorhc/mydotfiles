...
hl.bind(mainMod .. " + SLASH", hl.dsp.exec_cmd(ipc .. "settings toggle"))
...
hl.bind(mainMod .. " + COMMA", hl.dsp.exec_cmd(ipc .. "launcher emoji"))
...
hl.bind(mainMod .. " + SHIFT + T", hl.dsp.exec_cmd(ipc .. "darkMode toggle"))
